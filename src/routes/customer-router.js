...
module.exports = (app) => {
  ...
  app.put('/api/v1/customers/cpc', (req, res) => customerController.updateCPC(req, res))
  ...
  app.post('/api/v1/pool_customers', (req, res) => customerController.getPoolByCpfCnpj(req, res))
  app.post('/api/v1/pool_customers_by_id', (req, res) => customerController.getPoolById(req, res))
